...
import { VerifyEmailAction } from "@/features/white-label/components/verify-email-action";
    ...
    <main className="min-h-screen py-10">
      <section className="shell grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="panel rounded-[2rem] p-6 sm:p-8">
          ...
          <h1 className="mt-4 text-4xl font-semibold tracking-[-0.05em]">Validar e-mail</h1>
          <p className="mt-4 max-w-xl text-sm leading-7 text-muted">
            Confirme o e-mail cadastrado para concluir a ativacao da conta neste tenant.
          </p>
        </div>
        <div className="panel rounded-[2rem] p-6 sm:p-8">
          <VerifyEmailAction tenantSlug={tenantSlug} token={token} />
        </div>
      </section>
    </main>
  );
